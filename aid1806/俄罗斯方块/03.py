...
class RenjuBoard(object):
     ...
     def move(self, row, col, is_black):
          ...
          # 判断不能在相同位置下棋self._board[row][col]为0  EMPTY为0
          if self._board[row][col] == EMPTY:
               # 判断这是谁下的棋,BLACK=1表示黑棋,WHITE=2表示白棋
     ...
     while running:
          ...
          for event in pygame.event.get():
               ...
               # pygame.MOUSEBUTTONDOWN表示鼠标的键被按下
                               ...
                               event.button == 1 and is_black and is_refresh:  # button表示鼠标左键
                    x, y = event.pos  # 拿到鼠标当前在窗口上的位置坐标

                    un = "mx xq {0} {1}".format(str(x), str(y))
                    s.send(un.encode())
...
# L = [(2,3),(2,5),(3,4),(2,6),(2,10),(2,11),(2,7),(3,4),(3,5),(3,10),(4,2),
#      (5,2),(6,2),(7,2),(8,2),(2,8),(2,9)]
#
#
# L.sort()
